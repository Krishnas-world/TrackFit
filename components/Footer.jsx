        ...
        <div className="-m-8 flex flex-wrap items-center justify-between">
          ...
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center">
              <li className="p-5">
                <Link className="font-medium text-white-600 hover:text-blue-600" href="#">
                  Privacy Policy
                </Link>
              </li>
              <li className="p-5">
          ...
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <Link href="#">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-white-300 hover:border-white-400">
                    <svg
                      width="8"
                      height="14"
                      viewBox="0 0 8 14"
